...
public class Pvr_UnitySDKManager : MonoBehaviour
{
    ...
    public SystemDisplayFrequency displayFrequency = SystemDisplayFrequency.Default;
    ...
    {
        Debug.Log("PvrLog DisplayRefreshRateCallBack" + rate);
    ...
    private IEnumerator OnResume()
    {
        switch (displayFrequency)
        {
            case SystemDisplayFrequency.Default:
                {
                    Render.UPvr_SetDisplayFrequency(-1.0f);
                    break;
                }
            case SystemDisplayFrequency.RefreshRate72:
                {
                    Render.UPvr_SetDisplayFrequency(72.0f);
                    break;
                }
            case SystemDisplayFrequency.RefreshRate90:
                {
                    Render.UPvr_SetDisplayFrequency(90.0f);
                    break;
                }
            default:
