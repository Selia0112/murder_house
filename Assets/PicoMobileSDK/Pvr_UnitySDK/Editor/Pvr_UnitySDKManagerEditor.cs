...
public class Pvr_UnitySDKManagerEditor : Editor, IPreprocessBuild
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        guiContent.text = "Display Refresh Rates";
        guiContent.tooltip = "Set the system display refresh rates";
        manager.displayFrequency = (SystemDisplayFrequency) EditorGUILayout.EnumPopup(guiContent, manager.displayFrequency);
